<script languaje="javascript"><!--
    ...
    --></script>
<?php
    define("PATH_EXAMPLES","/home/jmrojas/public_html/jhsys/examples/");
    define("EXAMPLES",PATH_EXAMPLES."ExamplesList");
    define("JHSYS_SHELL","../../shell/pet");
//$java_path="/usr/bin/javac";
    define("JAVA_PATH","/usr/bin/javac");
    define("TMP_JHSYS","/home/jmrojas/public_html/jhsys/tmp/");
    define("TMP_WEB",TMP_JHSYS."web/");
    define("JHSYS_WEB_EXEC","jhsys_web.sh");
